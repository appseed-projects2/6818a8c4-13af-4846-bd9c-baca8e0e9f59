...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-08 18:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6818a8c4-13af-4846-bd9c-baca8e0e9f59.git
$ cd 6818a8c4-13af-4846-bd9c-baca8e0e9f59
```
